import {App, onBeforeUnmount, onMounted} from 'vue';
import mitt from 'mitt';
import {config} from '@/config.ts';
import {ClientMessage, CloseCode, ServerBroadcast, ServerMessage, ServerMessageType} from 'proto';
...
export function RealtimePlugin(_: App) {}