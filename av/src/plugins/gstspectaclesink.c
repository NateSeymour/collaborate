...
static void gst_spectaclesink_get_times (GstBaseSink * sink, GstBuffer * buffer,
...
G_DEFINE_TYPE_WITH_CODE (GstSpectaclesink, gst_spectaclesink, GST_TYPE_BASE_SINK,
  GST_DEBUG_CATEGORY_INIT (gst_spectaclesink_debug_category, "spectaclesink", 0,
  "debug category for spectaclesink element"));

static void
gst_spectaclesink_class_init (GstSpectaclesinkClass * klass)
{
...
static void
gst_spectaclesink_init (GstSpectaclesink *spectaclesink)
{
}
...
void
gst_spectaclesink_dispose (GObject * object)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (object);
...
void
gst_spectaclesink_finalize (GObject * object)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (object);
...
static GstCaps *
gst_spectaclesink_get_caps (GstBaseSink * sink, GstCaps * filter)
{
...
static gboolean
gst_spectaclesink_set_caps (GstBaseSink * sink, GstCaps * caps)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (sink);
...
static GstCaps *
gst_spectaclesink_fixate (GstBaseSink * sink, GstCaps * caps)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (sink);
...
static gboolean
gst_spectaclesink_start (GstBaseSink * sink)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (sink);
...
static gboolean
gst_spectaclesink_stop (GstBaseSink * sink)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (sink);
 ...
 * any function ASAP. */
static gboolean
gst_spectaclesink_unlock (GstBaseSink * sink)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (sink);
 ...
 * set during unlock */
static gboolean
gst_spectaclesink_unlock_stop (GstBaseSink * sink)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (sink);
...
static gboolean
gst_spectaclesink_query (GstBaseSink * sink, GstQuery * query)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (sink);
...
static gboolean
gst_spectaclesink_event (GstBaseSink * sink, GstEvent * event)
{
  GstSpectaclesink *spectaclesink = GST_SPECTACLESINK (sink);
