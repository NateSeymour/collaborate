...
typedef void (*Client_Closure)(const Client * message, void *closure_data);
typedef void (*ClientChatMessage_Closure)
 (const ClientChatMessage * message, void *closure_data);
typedef void (*ClientMessage_Closure)
 (const ClientMessage * message, void *closure_data);
