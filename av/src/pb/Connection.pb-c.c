...
static const ProtobufCEnumValue close_code__enum_values_by_number[6] = {
	...
	{"CLOSE_CODE_ROOM_EXPIRED", "CLOSE_CODE__CLOSE_CODE_ROOM_EXPIRED",
	 4001},
	{"CLOSE_CODE_CLIENT_USER_REQUESTED",
	 "CLOSE_CODE__CLOSE_CODE_CLIENT_USER_REQUESTED", 4100},
	{"CLOSE_CODE_UNAUTHORIZED", "CLOSE_CODE__CLOSE_CODE_UNAUTHORIZED",
	 4401},
	{"CLOSE_CODE_NOTFOUND", "CLOSE_CODE__CLOSE_CODE_NOTFOUND", 4404},
};

static const ProtobufCIntRange close_code__value_ranges[] = {
	{0, 0}, {1006, 1}, {4001, 2}, {4100, 3}, {4401, 4}, {4404,
							     5},
	{0, 6}
};
